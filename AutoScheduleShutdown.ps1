...
function AssertVirtualMachinePowerState
{
    ...
    if($VirtualMachine.ResourceType -eq "Microsoft.ClassicCompute/virtualMachines")
    {
        ...
        Write-Output AssertVirtualMachinePowerState1
    ...
    elseif($VirtualMachine.ResourceType -eq "Microsoft.Compute/virtualMachines")
    {
        ...
        Write-Output AssertVirtualMachinePowerState2
...
try
{
    ...
    Connect-AzureRMAccount -EnvironmentName AzureUSGovernment -ServicePrincipal -Tenant $connection.TenantID `
    ...
    foreach($vm in $resourceManagerVMList)
    {
        ...
        if($vm.ResourceType -eq "Microsoft.Compute/virtualMachines" -and $vm.Tags.Count -gt 0 -and $vm.Tags.keys -contains "AutoShutdownSchedule")
        {
